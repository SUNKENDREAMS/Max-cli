...
import { getProjectHash, MAX_HEADROOM_DIR } from '../utils/paths.js'; // Renamed
...
export class GitService {
  ...
  private getHistoryDir(): string {
    ...
    return path.join(os.homedir(), MAX_HEADROOM_DIR, 'history', hash); // Renamed
  }
